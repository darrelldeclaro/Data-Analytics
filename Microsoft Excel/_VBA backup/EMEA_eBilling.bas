Attribute VB_Name = "EMEA_eBilling"
Public Sub EMEA_eBilling()
...
Workbooks.Open "C:\Users\darrell.declaro\Documents\Automation ver1.0\EMEA - eBilling\Extracted Raw Data\Results.xlsx"
Workbooks.Open "C:\Users\darrell.declaro\Documents\Automation ver1.0\EMEA - eBilling\EMEA eBilling (raw PBI).xlsx"

'*****PATH RESULT TO TEMPLATE*****'
Set wsSrc = Workbooks("Results.xlsx").Worksheets(1)
Set wsDst = Workbooks("EMEA eBilling (raw PBI).xlsx").Worksheets(1)
