Attribute VB_Name = "asp_MFC"
Public Sub ASP_ManualFileCreation()
...
Workbooks.Open "C:\Users\darrell.declaro\Documents\Automation ver1.0\ASP - Manual File Creation\Extracted Raw Data\Results.xlsx"
Workbooks.Open "C:\Users\darrell.declaro\Documents\Automation ver1.0\ASP - Manual File Creation\SAP MANUAL_FILE_COMBINED RAW (PBI).xlsx"

'*****PATH RESULT TO TEMPLATE*****'
Set wsSrc = Workbooks("Results.xlsx").Worksheets("Sheet1")
Set wsDst = Workbooks("SAP MANUAL_FILE_COMBINED RAW (PBI).xlsx").Worksheets("MANUAL_FILE_COMBINED")
